      ...
      <div class="container ">
	        <div class="row">
	               <div class="col-12 col-md-12 add">
	            	<a href="works_add.php" class="btn btn-success">新增網頁</a>
	        ...
	        <div class="row">
	          <div class="col-12 col-md-12">
	            ...
	            <table class="table">
	            	...
	            	<td><?php echo mb_substr($value['intro'],0,30).'...'; ?></td>
	            	<td><?php echo $value['image_path']; ?></td>
                    <td><?php echo $value['video_path']; ?></td>
                    <td><?php echo $value['upload_date']; ?></td>
	            	<td><a class="btn btn-success" href="work_edit.php?i=<?php echo $value['id']; ?>">編輯</a>
